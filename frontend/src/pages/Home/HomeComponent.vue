      ...
      <div>
        <div class="row">
          <div class="col-12 col-md-3">
            <CardsComponent :type="'Clientes'" :percentagem="'7%'" :icon="'fa-users'" :qtd="'7590'"/>
          </div>

          <div class="col-12 col-md-3">
            <CardsComponent :type="'Produtos'" :percentagem="'12%'" :icon="'fa-box'" :qtd="'350'"/>
          </div>
          ...
          <div class="col-12 col-md-3"> 
            <CardsComponent :type="'Relátorios'" :percentagem="'25%'" :icon="'fa-chart-bar'" :qtd="'30'"/>
          </div>
